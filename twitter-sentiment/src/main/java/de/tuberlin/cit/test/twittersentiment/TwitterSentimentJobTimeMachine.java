 ...
 * @author Sascha Wolke
 */
public class TwitterSentimentJobTimeMachine {
	private final static Logger log = LoggerFactory.getLogger(TwitterSentimentJobTimeMachine.class);
	...
	public static void main(String[] args) throws Exception {
		...
		double replayFactor = Double.parseDouble(args[3]);
		...
		DataStream<TweetRecord> tweetStream = env.addSource(new TimeBasedTweetSource(replayFactor));
	...
	private static void printUsage() {
		System.err.println("Parameters: <jobmanager-host>:<port> <output-file> <profile-name> <replay factor>");
